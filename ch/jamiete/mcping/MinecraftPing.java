...
public class MinecraftPing {
  ...
  public MinecraftPingReply getPing(String hostname, int port) throws IOException {
    ...
    validate(Integer.valueOf(port), "Port cannot be null.");
    ...
    return new MinecraftPingReply(hostname, port, bits[3], bits[1], bits[2], Integer.valueOf(bits[4]).intValue(), Integer.valueOf(bits[5]).intValue());
  }
  ...
  public MinecraftPingReply getPing(String response, String hostname, int port) throws IOException {
    ...
    return new MinecraftPingReply(hostname, port, bits[0], Integer.valueOf(bits[2]).intValue(), Integer.valueOf(bits[1]).intValue());
  }
