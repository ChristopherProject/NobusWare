...
public class MinecraftPingReply {
  ...
  public String toString() {
    return String.format("{\"ip\":\"%s\",\"port\":%s,\"maxPlayers\":%s,\"onlinePlayers\":%s,\"motd\":\"%s\",\"protocolVersion\":\"%s\",\"serverVersion\":\"%s\"}", new Object[] { getIp(), Integer.valueOf(getPort()), Integer.valueOf(getMaxPlayers()), Integer.valueOf(getOnlinePlayers()), getMotd(), getProtocolVersion(), getVersion() });
  }
}
