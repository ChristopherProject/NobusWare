...
import it.nobusware.client.mods.Collision;
...
import it.nobusware.client.mods.VanillaFly;
...
public class ModuleManager {
	...
	public ModuleManager() {
		...
		Aggiungi(new VanillaFly("VanillaFly", Keyboard.KEY_F, "VanillaFly", Category.Movimenti));
		Aggiungi(new Collision("Collision", 0, "Collision", Category.Movimenti));
