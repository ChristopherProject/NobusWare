...
public class CrasherB extends Module {
	
	public CrasherB(String nome_mod, int tasto, String nome_array_printed, Category categoria) {
	...
	public void Abilitato() {
		...
		ChatUtils.print("Trying to crash with method B ( Boom )");
	}
