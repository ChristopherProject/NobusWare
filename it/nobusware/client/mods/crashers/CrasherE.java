...
public class CrasherE extends Module {

	public CrasherE(String nome_mod, int tasto, String nome_array_printed, Category categoria) {
	...
	public void Abilitato() {
		...
		ChatUtils.print("Trying to crash with method BB ( Big Boom )");
	}
