...
package it.nobusware.client.utils.test.player;
...
import it.nobusware.client.utils.test.util.Decoder;
import it.nobusware.client.utils.test.util.Frame;
import it.nobusware.client.utils.test.util.SampleBuffer;
import it.nobusware.client.utils.test.util.SoundStream;
...
public class MP3Player extends JPanel {
  ...
  private transient volatile boolean shuffle = true;
