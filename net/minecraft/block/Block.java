...
public class Block
{
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
        ...
        CollisionEvent collisione = new CollisionEvent(collidingEntity, pos.getX(), pos.getY(), pos.getZ(), axisalignedbb, this);
        EventAPI.fire(collisione);
        axisalignedbb = collisione.getBoundingBox();
        if (collisione.isCancelled())
          return; 
    ...
    {
    	//val = 0.5
    	return new AxisAlignedBB((double)pos.getX() + this.minX, (double)pos.getY() + this.minY, (double)pos.getZ() + this.minZ, (double)pos.getX() + this.maxX, (double)pos.getY() + this.maxY /*(dval)*/, (double)pos.getZ() + this.maxZ);//return new AxisAlignedBB(0, 0, 0, 0, 0, 0);//return  new AxisAlignedBB((double)pos.getX() + this.minX, (double)pos.getY() + this.minY, (double)pos.getZ() + this.minZ, (double)pos.getX() + this.maxX, (double)pos.getY() + this.maxY, (double)pos.getZ() + this.maxZ);
    }
