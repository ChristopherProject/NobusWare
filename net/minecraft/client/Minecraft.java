...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private static final ResourceLocation locationMojangPng = new ResourceLocation("nobita/mojang.png");
    ...
    private void startGame() throws LWJGLException
    {
        ...
        this.getNobita().getDiscord().start();
        this.ingameGUI = new GuiIngame(this);
        //vai nella cazzo di gui
    ...
    private void func_180510_a(TextureManager p_180510_1_)
    {
        ...
        try
        {
            ...
            p_180510_1_.bindTexture(locationMojangPng);
        }
    ...
    public void shutdownMinecraftApplet()
    {
        try
        {
            ...
            this.getNobita().getDiscord().shutdown();
            this.getNobita().StopClient();
            ...
            switch (Minecraft.SwitchEnumMinecartType.field_152390_a[this.objectMouseOver.typeOfHit.ordinal()])
            {
                ...
                case 2:
                    ...
                    if (this.theWorld.getBlockState(var3).getBlock().getMaterial() != Material.air)
                    {
                        ...
                        if (this.playerController.placeBlock(this.thePlayer, this.theWorld, var2, var3, this.objectMouseOver.field_178784_b, this.objectMouseOver.hitVec))
                        {
                            var1 = false;
                            this.thePlayer.swingItem();
                        }
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                    	KeyPressedEvent event2 = new KeyPressedEvent(var1);
                    	EventAPI.fire(event2);
                    	
                    	for(Module m : getNobita().getModManager().getHackDelClient()) {
                    		if(var1 == m.getTasto()) {
                    			m.toggle();
                    		}
                    	}
    ...
    public boolean setPause(boolean state)
    {
        return state = this.isGamePaused;
    }
