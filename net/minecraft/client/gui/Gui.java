...
public class Gui
{
     ...
     */
    public static void drawRect(double d, double e, float h, double f, int color)
    {
        int var5;
        ...
        var10.addVertex((double)d, (double)f, 0.0D);
        var10.addVertex((double)h, (double)f, 0.0D);
        var10.addVertex((double)h, (double)e, 0.0D);
     ...
     */
    public static void drawModalRectWithCustomSizedTexture(float x, float y, float u, float v, float w, float h, float textureWidth, float textureHeight)
    {
        ...
        var11.addVertexWithUV((double)x, (double)(y + h), 0.0D, (double)(u * var8), (double)((v + (float)h) * var9));
        var11.addVertexWithUV((double)(x + w), (double)(y + h), 0.0D, (double)((u + (float)w) * var8), (double)((v + (float)h) * var9));
        var11.addVertexWithUV((double)(x + w), (double)y, 0.0D, (double)((u + (float)w) * var8), (double)(v * var9));
