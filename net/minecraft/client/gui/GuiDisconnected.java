...
public class GuiDisconnected extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new ExpandButton(0, this.width / 2 - 100, this.height / 2 + this.field_175353_i / 2 + this.fontRendererObj.FONT_HEIGHT, I18n.format("gui.toMenu", new Object[0])));
        for (final Module m : this.mc.getNobita().getModManager().getHackDelClient()) {
            if (m.isDangerous()) {
