...
public class GuiIngame extends Gui
{
    ...
    {
    	if(!mc.isGamePaused()) {
    		this.mc.getNobita().getDiscord().update("In Gioco ", this.mc.getSession().getUsername() + " - NobusWare Client");
    	}
        ...
        {
        	mc.getNobita().getNobiGui().NobitaRendering();
        ...
        if (this.mc.gameSettings.showDebugInfo)
        {
        	...
        	EventRendererGUI2D event = new EventRendererGUI2D();
        	EventAPI.fire(event);
        }
    ...
    {
    	//ChatUtils.print("§cThis Is Dangerous For Client");
        ...
        while (var12.hasNext())
        {
            ...
            //System.out.println("Value def -> " + var18);
            int var19 = p_180475_2_.getScaledWidth() - var241 + 2;
            
         
            int var18 = var231 - var11 * this.func_175179_f().FONT_HEIGHT + ArrayListUtil.y;
