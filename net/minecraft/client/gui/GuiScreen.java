...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    public void drawBackground(int tint) {
        ...
        this.mc.getTextureManager().bindTexture(new ResourceLocation("nobita/d.jpg"));
        Gui.drawScaledCustomSizeModalRect(0, 0, 0.0F, 0.0F, ScaledResolution.getScaledWidth(), sr.getScaledHeight(), ScaledResolution.getScaledWidth(), sr.getScaledHeight(), ScaledResolution.getScaledWidth(), sr.getScaledHeight());
      }
