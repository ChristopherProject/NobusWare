...
public class GuiSelectWorld extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        this.mc.getNobita().getDiscord().update("Nel Menu' SinglePlayer", this.mc.getSession().getUsername() + " - NobusWare Client");
        try
        {
            this.func_146627_h();
        }
    ...
    {
    	int w = 9;
    	 this.buttonList.add(this.field_146641_z = (GuiButton)new ImageButton(1, width / 2 - 120 - w - w - w, height - 62, 40, 40, I18n.format("Play World", new Object[0]), "nobita/button/singleplayer/play.png"));
    	    this.buttonList.add(this.field_146631_B = (GuiButton)new ImageButton(7, width / 2 - 40 - w, height - 62, 40, 40, I18n.format("selectWorld.recreate", new Object[0]), "nobita/button/singleplayer/recreate.png"));
    	    this.buttonList.add(new ImageButton(3, width / 2 + w, height - 62, 40, 40, I18n.format("New World", new Object[0]), "nobita/button/singleplayer/create.png"));
    	    this.buttonList.add(this.field_146630_A = (GuiButton)new ImageButton(6, width / 2 - 80 - w - w, height - 62, 40, 40, I18n.format("selectWorld.rename", new Object[0]), "nobita/button/singleplayer/edit.png"));
    	    this.buttonList.add(this.field_146642_y = (GuiButton)new ImageButton(2, width / 2 + 40 + w + w, height - 62, 40, 40, I18n.format("selectWorld.delete", new Object[0]), "nobita/button/singleplayer/delete.png"));
    	    this.buttonList.add(new ImageButton(0, width / 2 + 80 + w + w + w, height - 62, 40, 40, I18n.format("gui.cancel", new Object[0]), "nobita/button/singleplayer/exit.png"));
