...
public class Main
{
    ...
    public static void main(String[] p_main_0_)
    {
        ...
        ArgumentAcceptingOptionSpec var11 = var1.accepts("username").withRequiredArg().defaultsTo("NobusWare" + Minecraft.getSystemTime() % 1000L, new String[0]);
        ...
        Thread.currentThread().setName("NobusWare");
...
//			HttpURLConnection connected2 = (HttpURLConnection) link.openConnection();
...
//				if(object.getString(Minecraft.getMinecraft().getSession().getUsername().toString()).toString().contains("true")) {
//					System.out.println("[Protection] Avvio Del Client Approvato (Premium)");	
//					GuiMainMenu.isAutorized = true;
//				}else if(object.getString(Minecraft.getMinecraft().getSession().getUsername().toString()).toString().contains("false")) {
//					GuiMainMenu.isAutorized = false;
//					System.out.println("[Protection] Avvio Del Client Non Approvato (Cracked Version)");
//					JOptionPane.showMessageDialog(null, "La Versione Corrente Del Client Risulta Craccata.", "Avviso ~ AdrianCode", 1);
//				}
//			}
//		}catch (Exception e) {
//			GuiMainMenu.isAutorized = false;
//			JOptionPane.showMessageDialog(null, "Non è Stato Possibile Contattare Il Server.", "Avviso ~ AdrianCode", 1);
//		}
//	}
}