...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float p_78440_1_) {
        ...
        func_178109_a((AbstractClientPlayer)var3);
        func_178110_a(var3, p_78440_1_);
        GlStateManager.enableRescaleNormal();
        GlStateManager.pushMatrix();
        if (this.itemToRender != null) {
          if (this.itemToRender.getItem() instanceof net.minecraft.item.ItemMap) {
            func_178097_a((AbstractClientPlayer)var3, var5, var2, var4);
          } else if (var3.getItemInUseCount() > 0 || Single.autoblfake) {
            double h;
            ...
            switch (SwitchEnumAction.field_178094_a[var7.ordinal()]) {
              ...
              case 2:
              case 3:
                func_178104_a((AbstractClientPlayer)var3, p_78440_1_);
                func_178096_b(var2, 0.0F);
                break;
              case 4:
              ...
              case 5:
                func_178096_b(var2, 0.0F);
                func_178098_a(p_78440_1_, (AbstractClientPlayer)var3);
                break;
            } 
          }  else
          {
