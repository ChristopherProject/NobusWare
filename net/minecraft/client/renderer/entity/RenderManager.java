...
public class RenderManager {
	...
	public void func_180597_a(World worldIn, FontRenderer p_180597_2_, Entity p_180597_3_, Entity p_180597_4_,
			GameSettings p_180597_5_, float p_180597_6_) {
		...
		if (p_180597_3_ instanceof EntityLivingBase && ((EntityLivingBase) p_180597_3_).isPlayerSleeping()) {
			...
			if (Reflector.callBoolean(Reflector.ForgeBlock_isBed,
				...
				EnumFacing var9 = (EnumFacing) Reflector.call(var8, Reflector.ForgeBlock_getBedDirection,
			...
			this.playerViewY = p_180597_3_.prevRotationYaw
					+ (p_180597_3_.rotationYaw - p_180597_3_.prevRotationYaw) * p_180597_6_;
			this.playerViewX = p_180597_3_.prevRotationPitch
		...
		this.viewerPosX = p_180597_3_.lastTickPosX
				+ (p_180597_3_.posX - p_180597_3_.lastTickPosX) * (double) p_180597_6_;
		this.viewerPosY = p_180597_3_.lastTickPosY
				+ (p_180597_3_.posY - p_180597_3_.lastTickPosY) * (double) p_180597_6_;
		this.viewerPosZ = p_180597_3_.lastTickPosZ
				+ (p_180597_3_.posZ - p_180597_3_.lastTickPosZ) * (double) p_180597_6_;
	}
	...
	public boolean func_178635_a(Entity p_178635_1_, ICamera p_178635_2_, double p_178635_3_, double p_178635_5_,
			double p_178635_7_) {
	...
	public boolean renderEntityStatic(Entity p_147936_1_, float p_147936_2_, boolean p_147936_3_) {
		...
		return this.doRenderEntity(p_147936_1_, var4 - this.renderPosX, var6 - this.renderPosY, var8 - this.renderPosZ,
				var10, p_147936_2_, p_147936_3_);
	}
	...
	public boolean doRenderEntity(Entity p_147939_1_, double p_147939_2_, double p_147939_4_, double p_147939_6_,
		...
		try {
			...
			if (var11 != null && this.renderEngine != null) {
				...
				if (this.debugBoundingBox && !p_147939_1_.isInvisible() && !p_147939_10_) {
					try {
						this.renderDebugBoundingBox(p_147939_1_, p_147939_2_, p_147939_4_, p_147939_6_, p_147939_8_,
								p_147939_9_);
	...
	private void renderDebugBoundingBox(Entity p_85094_1_, double p_85094_2_, double p_85094_4_, double p_85094_6_,
		...
		AxisAlignedBB var12 = new AxisAlignedBB(var11.minX - p_85094_1_.posX + p_85094_2_,
		...
		if (p_85094_1_ instanceof EntityLivingBase) {
			float var16 = 0.01F;
			RenderGlobal.drawOutlinedBoundingBox(new AxisAlignedBB(p_85094_2_ - (double) var10,
					p_85094_4_ + (double) p_85094_1_.getEyeHeight() - 0.009999999776482582D,
					p_85094_6_ - (double) var10, p_85094_2_ + (double) var10,
					p_85094_4_ + (double) p_85094_1_.getEyeHeight() + 0.009999999776482582D,
					p_85094_6_ + (double) var10), 16711680);
		}
		...
		var14.addVertex(p_85094_2_ + var15.xCoord * 2.0D,
				p_85094_4_ + (double) p_85094_1_.getEyeHeight() + var15.yCoord * 2.0D,
