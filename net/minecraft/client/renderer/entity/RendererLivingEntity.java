...
public abstract class RendererLivingEntity extends Render
{
    ...
    public void doRender(EntityLivingBase p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] { p_76986_1_, this, Double.valueOf(p_76986_2_), Double.valueOf(p_76986_4_), Double.valueOf(p_76986_6_) })) {
          ...
          this.mainModel.swingProgress = getSwingProgress(p_76986_1_, p_76986_9_);
          ...
          try {
            float var19 = interpolateRotation(p_76986_1_.prevRenderYawOffset, p_76986_1_.renderYawOffset, p_76986_9_);
            float var11 = interpolateRotation(p_76986_1_.prevRotationYawHead, p_76986_1_.rotationYawHead, p_76986_9_);
            ...
            if (this.mainModel.isRiding && p_76986_1_.ridingEntity instanceof EntityLivingBase) {
              ...
              var12 = var11 - var19;
              float f = MathHelper.wrapAngleTo180_float(var12);
              if (f < -85.0F)
                f = -85.0F; 
              if (f >= 85.0F)
                f = 85.0F; 
            ...
            float var201 = p_76986_1_.prevRotationPitchHead + (p_76986_1_.rotationPitchHead - p_76986_1_.prevRotationPitchHead) * p_76986_9_;
            renderLivingAt(p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_);
            float var14 = handleRotationFloat(p_76986_1_, p_76986_9_);
            ...
            this.mainModel.setRotationAngles(var17, var16, var14, var12, var201, 0.0625F, (Entity)p_76986_1_);
            if (this.field_177098_i) {
              boolean var18 = func_177088_c(p_76986_1_);
              renderModel(p_76986_1_, var17, var16, var14, var12, var201, 0.0625F);
              if (var18)
                func_180565_e(); 
            } else {
              if (p_76986_1_ instanceof EntityPlayer && !(p_76986_1_ instanceof EntityPlayerSP)) {
                RenderEntityEvent pre = new RenderEntityEvent(p_76986_1_, true);
                EventAPI.fire((Event)pre);
              } 
              boolean var18 = func_177090_c(p_76986_1_, p_76986_9_);
              renderModel(p_76986_1_, var17, var16, var14, var12, var201, 0.0625F);
              if (p_76986_1_ instanceof EntityPlayer && !(p_76986_1_ instanceof EntityPlayerSP)) {
                RenderEntityEvent post = new RenderEntityEvent(p_76986_1_, false);
                EventAPI.fire((Event)post);
              } 
              if (var18)
                func_177091_f(); 
          ...
          if (!this.field_177098_i)
            super.doRender((Entity)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_); 
