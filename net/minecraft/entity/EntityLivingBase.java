...
public abstract class EntityLivingBase extends Entity
{
    ...
    public void onEntityUpdate() {
        ...
        if (isEntityAlive())
          if (isEntityInsideOpaqueBlock()) {
            ...
            if (var2 < 0.0D)
              attackEntityFrom(DamageSource.inWall, Math.max(1, 
                    MathHelper.floor_double(-var2 * this.worldObj.getWorldBorder().func_177727_n()))); 
          }  
        ...
        if (!this.worldObj.isRemote) {
          ...
          for (int var2 = 0; var2 < 5; var2++) {
            ...
            if (!ItemStack.areItemStacksEqual(var4, var3)) {
              ((WorldServer)this.worldObj).getEntityTracker().sendToAllTrackingEntity(this, (Packet)new S04PacketEntityEquipment(
                    getEntityId(), var2, var4));
              if (var3 != null)
    ...
    public void func_180426_a(double p_180426_1_, double p_180426_3_, double p_180426_5_, float p_180426_7_, float p_180426_8_, int p_180426_9_, boolean p_180426_10_) {
        ...
        this.rotationPitchHead = p_180426_8_;
